...
namespace OpenLDR.Dashboard.API.Models
{
	...
	public class VLClient
	{
		...
		#region Methods
		#region All
		public static VLClient All(IConfigurationSection configuration, string connectionString, string province, string district, string facility, DateTime? stdate, DateTime? edate)
		{

			VLClient obj = null;
			var query = Core.GetQueryScript(configuration, "general_getHIVVLClients");
